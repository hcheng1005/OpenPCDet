...
def build_backbone_multihead(ckpt , cfg ):
    ...
    gridx = grid_size[0].astype(np.int32)
    gridy = grid_size[1].astype(np.int32)
...
if __name__ == "__main__":
    ...
    export_onnx_file = "./about_nuscenes/export/pointpillars/output/cbgs_pp_multihead_backbone.onnx"
    model.eval().cuda()

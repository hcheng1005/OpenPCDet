...
def parse_config():
    ...
    parser.add_argument('--cfg_file', type=str, default='cfgs/nuscenes_models/cbgs_pp_centerhead_multihead_.yaml',
...
def main():
    ...
    with torch.no_grad():
      ...
      torch.onnx.export(model,       # model being run
          ...
          "./centerpoint.onnx",  # where to save the model (can be a file or file-like object)
